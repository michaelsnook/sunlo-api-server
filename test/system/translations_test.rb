...
class TranslationsTest < ApplicationSystemTestCase
  ...
  test "creating a Translation" do
    ...
    fill_in "Language", with: @translation.language_id
    fill_in "Localised Text", with: @translation.localised_text
    fill_in "Phrase", with: @translation.phrase_id
    fill_in "Text", with: @translation.text
