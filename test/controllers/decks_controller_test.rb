...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { language_id: @deck.language_id, user_id: @deck.user_id } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { language_id: @deck.language_id, user_id: @deck.user_id } }
