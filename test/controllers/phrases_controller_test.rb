...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post phrases_url, params: { phrase: { text: @phrase.text, language_id: @phrase.language_id, localised_text: @phrase.localised_text } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { text: @phrase.text, language_id: @phrase.language_id, localised_text: @phrase.localised_text } }
