...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post translations_url, params: { translation: { language_id: @translation.language_id, localised_text: @translation.localised_text, phrase_id: @translation.phrase_id, text: @translation.text } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { language_id: @translation.language_id, localised_text: @translation.localised_text, phrase_id: @translation.phrase_id, text: @translation.text } }
